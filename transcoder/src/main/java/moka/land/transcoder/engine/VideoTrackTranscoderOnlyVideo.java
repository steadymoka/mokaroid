...
import moka.land.transcoder.format.MediaFormatExtraConstants;

// Refer: https://android.googlesource.com/platform/cts/+/lollipop-release/tests/tests/media/src/android/media/cts/ExtractDecodeEditEncodeMuxTest.java
public class VideoTrackTranscoderOnlyVideo implements TrackTranscoder {
    ...
    private final QueuedMuxerOnlyVideo mMuxer;
    ...
    public VideoTrackTranscoderOnlyVideo(MediaExtractor extractor, int trackIndex,
                                         MediaFormat outputFormat, QueuedMuxerOnlyVideo muxer) {
    ...
    private int drainEncoder(long timeoutUs) {
        ...
        switch (result) {
            ...
            case MediaCodec.INFO_OUTPUT_FORMAT_CHANGED:
                ...
                mMuxer.setOutputFormat(QueuedMuxerOnlyVideo.SampleType.VIDEO, mActualOutputFormat);
                return DRAIN_STATE_SHOULD_RETRY_IMMEDIATELY;
            case MediaCodec.INFO_OUTPUT_BUFFERS_CHANGED:
                mEncoderOutputBuffers = mEncoder.getOutputBuffers();
                return DRAIN_STATE_SHOULD_RETRY_IMMEDIATELY;
        ...
        mMuxer.writeSampleData(QueuedMuxerOnlyVideo.SampleType.VIDEO, mEncoderOutputBuffers[result], mBufferInfo);
